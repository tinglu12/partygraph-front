        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          <div className="flex-1 relative w-full">
            <Input
              ...
              disabled={isLoading}
              className="w-full h-18 text-xl px-8 bg-white/15 backdrop-blur-sm border-white/30 text-white placeholder:text-gray-300 focus:bg-white/20 focus:border-purple-400/70 focus:shadow-2xl focus:shadow-purple-500/30 transition-all duration-300 rounded-2xl pr-14 shadow-lg"
            />
          ...
          <div className="flex flex-row gap-2 items-center w-full sm:w-auto">
            ...
            {mounted && availableTags.length > 0 && (
              <select
                className="h-18 px-4 pr-10 bg-white/15 text-gray-300 text-xl rounded-2xl border border-white/30 focus:border-blue-400/70 focus:ring-2 focus:ring-blue-500/20 transition-all duration-300 outline-none min-w-[180px] [&>option:not(:disabled)]:text-white [&>option:not(:disabled)]:bg-slate-800 shadow-lg"
                disabled={isLoading}
                defaultValue=""
                onChange={e => {
