...
import { Calendar, MapPin, Users, Tag, Sparkles, Clock, Star } from 'lucide-react';
      ...
      <div className="text-center text-gray-400 py-16">
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-12 max-w-md mx-auto border border-white/10">
          ...
          <p className="text-gray-400 leading-relaxed">
            We couldn't find any events matching your search. Try a different vibe or browse our available tags.
          </p>
        </div>
      </div>
    );
    ...
    <div className="space-y-8">
      ...
      {(title || subtitle) && (
        <div className="text-center">
          ...
          {subtitle && (
            <p className="text-gray-300 text-lg max-w-2xl mx-auto leading-relaxed">{subtitle}</p>
          )}
            ...
            >
              ...
              {event.tags && event.tags.length > 0 && (
                <div className="mb-6">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-xs text-gray-400 font-medium uppercase tracking-wider">Tags</span>
                  </div>
              ...
              {event.connections && event.connections.length > 0 && (
                <div className="flex items-center gap-2 text-xs text-gray-400 pt-4 border-t border-white/10">
                  ...
                  <span>
                    Connected to <span className="font-semibold text-green-300">{event.connections.length}</span> other event{event.connections.length !== 1 ? 's' : ''}
                  </span>
                </div>
              )}
        ...
        <div className="text-center pt-8 border-t border-white/10">
          <div className="flex items-center justify-center gap-6 text-sm text-gray-400">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>{new Set(events.flatMap(e => e.tags || [])).size} unique tags</span>
            </div>
